...
export class DataService {
    ...
    async getRouteExceptCurrent(userId: string): Promise<any[]> {
        try {
            ...
            console.log(
                'Querying users except for the one with userId:',
                userId
            );
